...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
            optionsBuilder.UseNpgsql("Host=localhost;Database=exams;Username=user1;Password=user1");
        }
    }
        ...
        modelBuilder.Entity<Program>(entity =>
        {
            ...
            entity.HasMany(d => d.Courses)
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Program>().WithMany().HasForeignKey("ProgramId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("program_course_program_id_fkey"),
                    j =>
                    {
            ...
            entity.HasMany(d => d.Students)
                ...
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Program>().WithMany().HasForeignKey("ProgramId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("program_student_program_id_fkey"),
                    j =>
                    {
